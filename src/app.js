...
function moreAboutKaren(parents, noOfSiblings, isNuclearFamily) {
  ...
  if (
    ...
    isNuclearFamily == undefined
  )
    return false;
  else if (typeof parents == "string")
    if (typeof noOfSiblings == "number")
      if (typeof isNuclearFamily == "boolean") return true;
      else return false;
}
...
function sweetTooth(
  ...
  if (
    (((typeof totalNoOfSweets == typeof sweetsConsumedByKaren) ==
      typeof sweetsConsumedInNMeters) ==
      typeof metersToTravel) ==
    "number"
  ) {
    if (
      totalNoOfSweets +
      ...
      karenate =
        totalNoOfSweets + sweetsConsumedByKaren + sweetsConsumedInNMeters;
    }
  } else {
